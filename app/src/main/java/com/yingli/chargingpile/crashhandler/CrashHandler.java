package com.yingli.chargingpile.crashhandler;
...
import com.yingli.chargingpile.util.DateUtil;
import com.yingli.chargingpile.util.FileUtils;
    ...
    private boolean handleException(Throwable ex) {
        ...
        try {
            ...
            new Thread() {
                ...
                public void run() {
                    Looper.prepare();
                    Toast.makeText(mContext, R.string.m63系统错误,
