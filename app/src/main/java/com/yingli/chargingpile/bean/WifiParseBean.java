...
public class WifiParseBean {
    ...
    public void setBltPwd(String bltPwd) {
        this.bltPwd = bltPwd;
    }
    ...
    public void setName4G(String name4G) {
        this.name4G = name4G;
    }
    ...
    public void setPwd4G(String pwd4G) {
        this.pwd4G = pwd4G;
    }
    ...
    public void setApn4G(String apn4G) {
        this.apn4G = apn4G;
    }
    ...
    public void setChargingEnable(String chargingEnable) {
        this.chargingEnable = chargingEnable;
    }
