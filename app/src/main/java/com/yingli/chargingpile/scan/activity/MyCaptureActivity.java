package com.yingli.chargingpile.scan.activity;
...
import com.yingli.chargingpile.scan.MyCameraManger;
import com.yingli.chargingpile.scan.MyCaptureActivityHandler;
import com.yingli.chargingpile.scan.MyViewfinderView;
...
public class MyCaptureActivity extends BaseActivity implements SurfaceHolder.Callback, View.OnClickListener{
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        builder.setTitle(getString(R.string.m137扫码添加));
        ...
        if (requestCode == Constant.REQUEST_IMAGE && resultCode == RESULT_OK) {
            ...
            new DecodeImgThread(path, new DecodeImgCallback() {
                ...
                public void onImageDecodeFailed() {
                    Toast.makeText(MyCaptureActivity.this, "抱歉，解析失败,换个图片试试.", Toast.LENGTH_SHORT).show();
                }
            }).run();
